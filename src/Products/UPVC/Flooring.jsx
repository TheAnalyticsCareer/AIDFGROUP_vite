...
const Flooring = () => {
  ...
  const categories = [
    { 
      ...
      name: "Oak Flooring", 
      image: laminateImage,
      description: "Premium oak flooring options for residential and commercial spaces"
    },
    { 
      id: "glossyEngineered", 
          ...
          <div className="flooring-modal-content">
            ...
            <div className="flooring-modal-left">
              <div className="flooring-product-info">
                ...
                <h3 className="flooring-modal-product-title">{currentProduct.name}</h3>
                <div className="flooring-modal-price">{currentProduct.price}</div>
                ...
                <div className="flooring-modal-specs-container">
                  <ul className="flooring-modal-specs">
                    {currentProduct.details.map((detail, index) => (
                      <li key={index}>
                        <span className="flooring-modal-spec-label">{detail.label}:</span>{" "}
                        <span className="flooring-modal-spec-value">{detail.value}</span>
                      </li>
                    ))}
                  </ul>
                </div>
